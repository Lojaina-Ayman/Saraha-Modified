...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->scrollable_transaction_panel->Location = System::Drawing::Point(16, 99);
			this->scrollable_transaction_panel->Name = L"scrollable_transaction_panel";
			this->scrollable_transaction_panel->Size = System::Drawing::Size(950, 692);
			this->scrollable_transaction_panel->TabIndex = 12;
			// 
			// Chat
			// 
